...
export default function NycLiteraryMapPage() {
  return <main className="literary-page">
    <nav className="literary-nav" aria-label="Projects navigation"><Link href="/" className="brand-link" aria-label="Jingheng Huan home"><BrandMark /></Link><div><Link href="/portfolio/nyc-film-map">Film Map</Link><Link href="/#projects">← Projects</Link></div></nav>
