...
- On September 20, 2026, Jingheng unified all related knowledge under **Mortgage Map**. Keep one public identity and one complete catalog. Interest rates, curves, funding, currencies and wider credit belong inside this map; do not reintroduce separate subject-map brands, subject switches or lens-specific hidden concepts. Future research-inbox, evidence and assumption-review work belongs within Mortgage Map and must not be advertised as implemented before it exists.
