...
The Journal supports paragraph and section-heading blocks. When importing an owner-supplied document, retain the author's wording, remove exported comment anchors and the comment appendix, and do not silently apply suggestions inside comments. Confirm that full text may be stored in this public source repository before adding private document content. The two initial drafts are not included in this PR.
